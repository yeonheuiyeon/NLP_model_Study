...
with open("piqa_qna.jsonl", "w", encoding="utf-8") as f:
    for idx, data in enumerate(dataset):
        ...
        sol2=data['sol2']
        answer=data['label']
        prompt=f"{defalt_p}\n\n{B_INST} Is phrase 0 or phrase 1 appropriate to complete the given sentence? {E_INST}\n\nSentences that need to be completed : {cotent}\nCandidate phrase 0 : {sol1}\nCandidate phrase 1 : {sol2}\nAnswer : "
